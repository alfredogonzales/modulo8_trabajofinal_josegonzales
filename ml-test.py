...
insurance = int(input("Ingrese edad: "))
insurance_sc = sc_x.transform(np.array([[insurance]]))
#print(f"rooms_sc: {rooms_sc}")

prediction = model.predict(insurance_sc)
#print(f"Predicción: {prediction}")

prediction_sc = sc_y.inverse_transform(prediction)
print(f' El precio del seguro para {insurance} años es de: $ {prediction_sc[0][0]:.2f}')